...
async function HomePageTest(driver) {
    let loadingPage = await driver.findElement(By.className('landingPage'));
    let genericButton_blue = await driver.findElement(By.className('genericButton blue'));
    let genericButton_white = await driver.findElement(By.className('genericButton white'));
...
async function signinTest(driver, username, email, password, passwordConfirm) {
...
(async function () {
    ...
    try {
        await driver.wait(until.elementLocated(By.className('landingPage')), 30000);
